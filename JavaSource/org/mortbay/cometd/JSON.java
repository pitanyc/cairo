...
public class JSON
{
    ...
    public static void append(StringBuffer buffer, Object object)
    {
        ...
        else if (object instanceof UserBean) appendUserBean(buffer,(UserBean)object);                         /* CAIRO */
        else if (object instanceof MessageBean) appendMessageBean(buffer,(MessageBean)object);                /* CAIRO */
        else if (object instanceof MessageStyleBean) appendMessageStyleBean(buffer,(MessageStyleBean)object); /* CAIRO */
        else if (object instanceof TranslateBean) appendTranslateBean(buffer,(TranslateBean)object);		  /* CAIRO */
        else 
	...
	/* CAIRO... */
    private static void appendUserBean(StringBuffer buffer, UserBean user)
    {
        if (user==null)
        {
            appendNull(buffer);
		...
		buffer.append('{');
        QuotedStringTokenizer.quote(buffer, "userName");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, user.getUserName());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "status");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, Integer.toString(user.getStatus()));
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "customAwayMsg");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, user.getCustomAwayMsg());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "buddyIcon");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, user.getBuddyIcon());
        buffer.append("}");

		//System.out.println("\n\nappendUserBean: buffer: " + buffer.toString() + "\n\n");
    }

    private static void appendMessageBean(StringBuffer buffer, MessageBean message)
    {
        if (message==null)
        {
            appendNull(buffer);
		...
		buffer.append('{');
        QuotedStringTokenizer.quote(buffer, "hour");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, Integer.toString(message.getHour()));
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "minute");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, Integer.toString(message.getMinute()));
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "source");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, message.getSource());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "target");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, message.getTarget());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "message");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, message.getMessage());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "sourceBuddyIcon");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, message.getSourceBuddyIcon());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "style");
        buffer.append(':');
        appendMessageStyleBean(buffer, message.getStyle());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "translate");
        buffer.append(':');
        appendTranslateBean(buffer, message.getTranslate());
        buffer.append("}");

		//System.out.println("\n\nappendMessageBean: buffer: " + buffer.toString() + "\n\n");
    }

    private static void appendMessageStyleBean(StringBuffer buffer, MessageStyleBean style)
    {
        if (style==null)
        {
            appendNull(buffer);
		...
		buffer.append('{');
        QuotedStringTokenizer.quote(buffer, "color");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getColor());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "fontFamily");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getFontFamily());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "fontSize");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getFontSize());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "fontWeight");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getFontWeight());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "fontStyle");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getFontStyle());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "textDecoration");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, style.getTextDecoration());
        buffer.append("}");

		//System.out.println("\n\nappendMessageStyleBean: buffer: " + buffer.toString() + "\n\n");
    }

    private static void appendTranslateBean(StringBuffer buffer, TranslateBean bean)
    {
        if (bean==null)
        {
            appendNull(buffer);
		...
		buffer.append('{');
        QuotedStringTokenizer.quote(buffer, "enabled");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, Boolean.toString(bean.getEnabled()));
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "from");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, bean.getFrom());
        buffer.append(',');
        QuotedStringTokenizer.quote(buffer, "to");
        buffer.append(':');
        QuotedStringTokenizer.quote(buffer, bean.getTo());
        buffer.append("}");

		//System.out.println("\n\nappendTranslateBean: buffer: " + buffer.toString() + "\n\n");
    }
	/* ...CAIRO */
